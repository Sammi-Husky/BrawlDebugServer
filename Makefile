...
# RELID is the ID to assign the .rel once built
...
CCFLAGS		:= -msgstyle gcc -lang=c99 -Cpp_exceptions off -c -proc gekko -nostdinc -O4,s -inline auto -fp hard -u _prolog -u _epilog -u _unresolved -enum int -sdata 0 -sdata2 0 -func_align 4
